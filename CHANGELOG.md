...
* Added support to incorporate the log-likelihood generated by JAGS into ArviZ
...
* Amended the documentation at InferenceDataCookbook.ipynb to show how to calculate the log-likelihood in PyJAGS and how to use the information in ArviZ
