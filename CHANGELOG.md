...
* Integrate jointplot into pairplot, add point-estimate and overlay of plot kinds (#1079)
* New grayscale style. This also add two new cmaps `cet_grey_r` and `cet_grey_r` cmaps. These are perceptually uniform gray scale cmaps from colorcet (linear_grey_10_95_c0) (#1164)
