...
* Example data has been moved to the [arviz_example_data](https://github.com/arviz-devs/arviz_example_data) repository and is now included using git subtree. ([2105](https://github.com/arviz-devs/arviz/pull/2105))
