...
A short file needs to be created for any new user that explains or provides references to documentation to them. The file needs to cover the following aspects  -
1.	Subscribing to Arviz issues, which should include getting notified of updates or new issues
2.	How to unsubscribe manually from issues
3.	Explain how an occasional contributor can help with issues, without having triaging permission. This can include, but is not limited to –
...
4.	To be considered (as this can't be done yet)  - Provide a link to governance/contributing section about how to join ArviZ's private communication channels (and also get triage     permissions on github?) cc @canyon289
