...
defaultParams = {  # pylint: disable=invalid-name
    ...
    "plot.bokeh.layout.sizing_mode": ("fixed", _make_validate_choice({"fixed", "stretch_width", "stretch_height", "stretch_both", "scale_width", "scale_height", "scale_both"})),
    "plot.bokeh.layout.toolbar_location" : ("above", _make_validate_choice({"above", "below", "left", "right"}, allow_none=True)),
