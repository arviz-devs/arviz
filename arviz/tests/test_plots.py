...
def test_plot_density(plot_inputs, obj_attr):
    obj = getattr(plot_inputs, obj_attr)
...
def test_plot_trace(plot_inputs, combined, obj_attr):
    obj = getattr(plot_inputs, obj_attr)
...
def test_plot_forest(plot_inputs, obj_attrs, args_expected):
    obj = [getattr(plot_inputs, obj_attr) for obj_attr in obj_attrs]
...
def test_plot_energy(plot_inputs, obj_attr, kind):
    obj = getattr(plot_inputs, obj_attr)
...
@pytest.mark.parametrize("obj_attr", ["pymc3_fit", "stan_fit"])
def test_plot_parallel_exception(plot_inputs, obj_attr):
    obj = getattr(plot_inputs, obj_attr)
...
def test_plot_joint(plot_inputs, obj_attr, kind):
    obj = getattr(plot_inputs, obj_attr)
...
def test_plot_pair(plot_inputs, obj_attr, kwargs):
    obj = getattr(plot_inputs, obj_attr)
...
@pytest.mark.parametrize("obj_attr", ["pymc3_fit", "stan_fit"])
def test_plot_violin(plot_inputs, obj_attr):
    obj = getattr(plot_inputs, obj_attr)
...
@pytest.mark.parametrize("obj_attr", ["pymc3_fit", "stan_fit"])
def test_plot_autocorr_uncombined(plot_inputs, obj_attr):
    obj = getattr(plot_inputs, obj_attr)
...
@pytest.mark.parametrize("obj_attr", ["pymc3_fit", "stan_fit"])
def test_plot_autocorr_combined(plot_inputs, obj_attr):
    obj = getattr(plot_inputs, obj_attr)
...
@pytest.mark.parametrize("obj_attr", ["pymc3_fit", "stan_fit"])
def test_plot_posterior(plot_inputs, obj_attr):
    obj = getattr(plot_inputs, obj_attr)
...
def test_point_estimates(plot_inputs, obj_attr, point_estimate):
    obj = getattr(plot_inputs, obj_attr)
