...
def _convert_pyjags_samples_dictionary_to_arviz_samples_dictionary(
    ...
    """
    Takes a python dictionary of samples that has been generated by the sample method of a model instance and returns a dictionary of samples in ArviZ format.
...
def _convert_pyjags_samples_dict_to_arviz_inference_data(
    ...
    """
    Takes a python dictionary of samples that has been generated by the sample method of a model instance and returns an Arviz inference data object.
...
def _extract_samples_dictionary_from_arviz_inference_data(idata) \
        -> tp.Dict[str, np.ndarray]:
    """
    Extracts a dictionary mapping parameter names to NumPy arrays of samples with shape (number_of_chains, chain_length, parameter_dimension) from an ArviZ inference data object.
...
def _convert_arviz_samples_dictionary_to_pyjags_samples_dictionary(
        ...
        -> tp.Dict[str, np.ndarray]:
    """
    Takes a python dictionary of samples in ArviZ format and returns the samples as a dictionary in PyJAGS format.
